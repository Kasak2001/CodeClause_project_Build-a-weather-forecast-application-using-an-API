...
The project repository can be found in [GitHub link](https://github.com/Kasak2001/CodeClause_project_Build-a-weather-forecast-application-using-an-API) or just clone the project using this command. 
